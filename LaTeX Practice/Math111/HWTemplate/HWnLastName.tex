...
\begin{center}
\textbf{MATH 111, Assignment N Solutions}%CHANGE THIS EVERY WEEK
\end{center}

\vspace{.3 in}

\textbf{Name:}\underline{~~NAME(S) HERE~~} \hspace{1in} \textbf{Date:} \underline{~~DATE HERE~~}%CHANGE THIS EVERY WEEK
